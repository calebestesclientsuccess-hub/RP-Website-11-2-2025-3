...
- **Orbital Powers Animation**: Apple-inspired interactive video element featuring a maximized central video (896px desktop, 640px tablet, 448px mobile) with 6 orbital "powers" (AI Architect, GTM Strategist, RevOps, Elite Coach, Tech Stack, Community & Competition) that orbit around it. Video appears borderless against a red/blue geometric outer space background that extends from "You don't need another salesperson. You need leverage." section through the entire Orbital Powers section using fixed background attachment for parallax effect. Video plays automatically once, replaying only after scrolling away for 6+ seconds. Animation stops 2.5 seconds before video ends, badges expand outward with intensified glow, and labels appear with staggered animation. Navigation arrows are integrated into the info box for easy click access. Video uses object-contain to prevent face cutoff.
