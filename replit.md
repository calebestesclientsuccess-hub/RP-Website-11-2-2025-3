...
- **Orbital Powers Animation**: Apple-inspired interactive video element featuring a large central video (640px desktop, 512px tablet, 384px mobile) with 6 orbital "powers" (AI Architect, GTM Strategist, Support, Coach, Tools, Community & Competition) that orbit around it. Video plays automatically once, replaying only after scrolling away for 6+ seconds. Animation stops 2.5 seconds before video ends, badges expand outward with intensified glow, and labels appear with staggered animation. Centered "Learn More" button links to /solutions/fully-loaded-bdr-pod. Video uses object-contain to prevent face cutoff.
