export const projects = [
  {
    ...
    outcome: "Achieved 40% increase in qualified leads in the first quarter post-launch. Brand recall in customer surveys improved by 65%. Sales cycle shortened by 18 days. The CEO reported that prospects were now saying 'I've heard of you' in discovery calls—something that never happened before.",
  ...
  },
  {
    ...
    outcome: "Secured 12 enterprise pilot customers in the first month—exceeding their 6-month goal. Generated $2.1M in pipeline in quarter one. Press coverage in 3 industry publications. Sales team hit 85% of quota in a completely new market segment within 90 days.",
  ...
  },
  {
    ...
    solution: "We designed a comprehensive brand identity system including logo suite, color palette, typography system, iconography, photography guidelines, and brand applications across digital and print. The visual language balanced professionalism with approachability—bold colors, clean geometry, and human-centered imagery. Delivered a 60-page brand guidelines document.",
    ...
    testimonial: {
      text: "The rebrand wasn't just cosmetic—it changed how people perceive us. We went from 'legacy HR software' to 'modern platform for progressive companies.' That shift is priceless.",
